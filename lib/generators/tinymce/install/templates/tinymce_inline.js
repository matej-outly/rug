...
function tinymce_inline_ready()
{
	...
	tinymce.init({
		 ...
		 * Basic setting
		 */
		selector: ".tinymce.inline-edit.text", /* TinyMCE is applied to all elements with this class */
		...
		content_css: "/assets/libraries/tinymce_inline.css", /* Custom CSS file for content */
		 ...
		 */
		plugins: "paste charmap codemirror hr image link nonbreaking searchreplace table visualblocks visualchars",
		
		/**
		 * Toolbar
		 */
		toolbar: "undo redo | styleselect | link image | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist indent outdent | code",
	...
	tinymce.init({
		 ...
		 * Basic setting
		 */
		selector: ".tinymce.inline-edit.string", /* TinyMCE is applied to all elements with this class */
		theme: "modern", /* Theme of the editor */
		inline: true,
		/*language : "cs", /* Editor language */
		fix_list_elements : true, /* Fix nested ul/ol elements */
 ...
 * Hook
 */
$(document).ready(tinymce_inline_ready);