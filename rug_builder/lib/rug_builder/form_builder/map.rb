...
#			js += "	updateInputs: function(callback)\n"
#			js += "	{\n"
#			js += "		var _this = this;\n"
...
#			js += "		return true;\n"
#			js += "	},\n"
#			js += "	updateAddress: function(callback)\n"
#			js += "	{\n"
#			js += "		var _this = this;\n"
...
#			js += "	{\n"
#			js += "		var _this = this;\n"
#			js += "		var form = $('#address_location_' + this.hash).closest('form');\n"
#			js += "		var address_input = $('#address_location_' + this.hash + ' input.address');\n"
#			js += "		this.geocoder = new google.maps.Geocoder();\n"
#			js += "		address_input.autoComplete({\n"
#			js += "			minChars: 3,\n"
#			js += "			source: function(term, response) {\n"
#			js += "				if (_this.lock == false) {\n"
#			js += "					_this.lock = true;\n"
#			js += "					_this.suggest(term, function(results) {\n"
#			js += "						if (results) {\n"
#			js += "							suggestions = [];\n"
...
#			js += "}\n"
			...
			result += @template.text_field_tag("#{object.class.model_name.param_key}[#{name.to_s}][street]", "", class: "text input street", placeholder: "Ulice")
			result += @template.text_field_tag("#{object.class.model_name.param_key}[#{name.to_s}][number]", "", class: "text input number", placeholder: "Číslo")
			result += @template.text_field_tag("#{object.class.model_name.param_key}[#{name.to_s}][city]", "", class: "text input city", placeholder: "Město")
			

			# Location inputs
			result += @template.text_field_tag("#{object.class.model_name.param_key}[#{name.to_s}][latitude]", value_latitude, class: "latitude")
			result += @template.text_field_tag("#{object.class.model_name.param_key}[#{name.to_s}][longitude]", value_longitude, class: "longitude")
